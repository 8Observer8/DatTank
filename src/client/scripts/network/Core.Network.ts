...
class NetworkCore {
    ...
    public init ( server: any, callback: () => void ) : void {
        ...
        this.registerEvent( 'PlayerUpdateLevel', EventDir.IN, EventType.BIN, 90 );
        this.registerEvent( 'PlayerNewArenaSkill', EventDir.IN, EventType.BIN, 91 );
        this.registerEvent( 'PlayerStatsUpdate', EventDir.IN, EventType.BIN, 92 );
        ...
        this.registerEvent( 'TankSyncState', EventDir.IN, EventType.BIN, 122 );

        this.registerEvent( 'TankStartShooting', EventDir.IN, EventType.BIN, 123 );
        this.registerEvent( 'TankStopShooting', EventDir.IN, EventType.BIN, 124 );
